...
// CRIAR NO PROMPT 
    ...
    //CATEGORIA (copiar uma linha inteira )
        ...
        // PARA TESTE DE ERRO
            // curl -d "id_pk=3&nome=Outros&descricao=Pagar todo dia 5" http://localhost:3000/categoria
    ...
    //LANCAMENTO
            ...
            // curl -d "id_pk=3&descricao=gasolina no posto do Cincao&valor=120.00&data=2022-04-29&tipo=1&carteira_fk=3&categoria_fk=1" http://localhost:3000/lancamento 
